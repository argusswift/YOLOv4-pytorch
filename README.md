...
| name | train Dataset | test Dataset | test size | mAP | inference time(ms) |model |
| :----- | :----- | :------ | :----- | :-----| :-----|:-----|:-----|
| mobilenet-YOLOV4 | VOC trainval(07+12) | VOC test(07) | 416 | 0.878 |  11.29 |[VOC](https://pan.baidu.com/s/1-XLNmVMlqVip-vImOoe1kA) |
...
* Darknet pre-trained weight :  [yolov4](https://drive.google.com/open?id=1cewMfusmPjYWbrnuJRuKhPMwRe_b9PaT),[mobilenet-yolov4](https://pan.baidu.com/s/1sjixK2L9L0YgQnvfDuVTJQ)(code:args)
